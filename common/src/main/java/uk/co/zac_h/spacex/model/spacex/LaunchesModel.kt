...
data class LaunchesExtendedDocsModel(
    @field:Json(name = "docs") val docs: List<LaunchesExtendedModel>
)
...
data class LaunchesExtendedModel(
    ...
    @field:Json(name = "cores") val cores: List<LaunchCoreExtendedModel>?,
    @field:Json(name = "links") val links: LaunchLinksModel?,
    @field:Json(name = "auto_update") val autoUpdate: Boolean?,
    @field:Json(name = "id") val id: String
) : Parcelable