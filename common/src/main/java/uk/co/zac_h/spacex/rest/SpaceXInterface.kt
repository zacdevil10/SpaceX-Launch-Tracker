...
interface SpaceXInterface {
    ...
    fun getDragon(@Path(SPACEX_PARAM_ID) id: String): Call<Dragon>

    @GET(SPACEX_DRAGONS_QUERY)
    fun queryDragons(@Body body: QueryModel): Call<Dragon>
    ...
    fun getLaunchesPast(): Call<List<Launch>>

    @GET(SPACEX_LAUNCHES_UPCOMING)
    fun getLaunchesUpcoming(): Call<List<Launch>>

    @GET(SPACEX_LAUNCHES_LATEST)
    fun getLaunchesLatest(): Call<List<Launch>>

    @GET(SPACEX_LAUNCHES_NEXT)
    fun getLaunchesNext(): Call<List<Launch>>

    @GET(SPACEX_LAUNCHES)
    fun getLaunches(): Call<List<Launch>>

    @GET(SPACEX_LAUNCHES + SPACEX_GET_BY_PARAM_ID)
    fun getLaunch(@Path(SPACEX_PARAM_ID) id: String): Call<Launch>
    ...
    fun getLaunchpad(@Path(SPACEX_PARAM_ID) id: String): Call<LaunchpadModel>
    ...
    fun getShip(@Path(SPACEX_PARAM_ID) id: String): Call<Ship>
    ...
    @GET(SPACEX_HISTORY)
    fun getHistory(): Call<List<HistoryModel>>

    @GET(SPACEX_HISTORY + SPACEX_GET_BY_PARAM_ID)
    fun getHistoricalEvent(): Call<HistoryModel>
