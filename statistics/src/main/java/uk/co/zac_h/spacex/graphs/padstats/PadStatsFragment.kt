package uk.co.zac_h.spacex.graphs.padstats
...
import uk.co.zac_h.spacex.adapters.PadStatsSitesAdapter
import uk.co.zac_h.spacex.dto.spacex.StatsPadModel
import uk.co.zac_h.spacex.statistics.R
import uk.co.zac_h.spacex.statistics.databinding.FragmentPadStatsBinding
import uk.co.zac_h.spacex.utils.PadType

@AndroidEntryPoint
class PadStatsFragment : Fragment() {
