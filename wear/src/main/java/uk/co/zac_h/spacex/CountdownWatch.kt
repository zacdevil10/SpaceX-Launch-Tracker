 ...
 */
class CountdownWatch : CanvasWatchFaceService() {
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@CountdownWatch)
                    .build()
            )

            mCalendar = Calendar.getInstance()

            val resources = this@CountdownWatch.resources
        ...
        private fun registerReceiver() {
            ...
            this@CountdownWatch.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@CountdownWatch.unregisterReceiver(mTimeZoneReceiver)
        }
