...
class LaunchListPreviewParameterProvider : PreviewParameterProvider<List<LaunchItem>> {
    override val values: Sequence<List<LaunchItem>>
        get() = sequenceOf(
            listOf(
                ...
                LaunchItem(
                    id = "0098c032-73de-4c6f-8d73-5d68b9a12fd2",
                    upcoming = true,
                    missionPatch = null,
                    missionName = "OTV-7 (X-37B) (USSF-52)",
                    rocket = "Falcon Heavy",
                ...
                LaunchItem(
                    id = "0098c032-73de-4c6f-8d73-5d68b9a12fd5",
                    upcoming = true,
                    missionPatch = null,
                    missionName = "OTV-7 (X-37B) (USSF-52)",
                    rocket = "Falcon Heavy",
