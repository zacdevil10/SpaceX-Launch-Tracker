...
class HeaderItemDecorationHorizontal(
    ...
    init {
        ...
        recyclerView.doOnEachNextLayoutHorizontal {
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val contactPoint = headerView.right
...
inline fun View.doOnEachNextLayoutHorizontal(crossinline action: (view: View) -> Unit) {
