...
import uk.co.zac_h.spacex.datasource.remote.DashboardDataSourceClient
...
class DashboardRepository @Inject constructor(
    @DashboardDataSourceClient dashboardDataSource: RemoteDataSource<LaunchDocsModel>,
    cache: Cache<LaunchDocsModel>,
    private val preferences: DashboardPreferencesDataSource
) : Repository<LaunchDocsModel>(dashboardDataSource, cache) {
